...
fn main() {
    ...
    let static_objects = vec![
        ...
        StaticObject {
            center: Vector2::new(500.0, 200.0),
            width: 50.0,
            height: 50.0,
        },
    ];
    ...
    // cache object bounds
    let static_object_bounds: Vec<Vec<f64>> = static_objects
        .iter()
